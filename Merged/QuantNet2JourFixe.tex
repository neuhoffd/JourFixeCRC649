...
\frame{
	...
	\begin{enumerate}
		\item \textbf{Start:} Create GitHub repository with own code
		\item \textbf{Develop:} Develop according to style guide
...
\begin{figure}[htb]
	\begin{center}
		\href{http://sfb649.wiwi.hu-berlin.de/quantnet/d3/ia/}{
			%\includegraphics[height=6.8cm]{Figures/QD3_All_g}
