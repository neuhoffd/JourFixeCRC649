...
\section[Paradigm]{Modern Scientific Practice}
...
{\Large 		\textbf{QuantNet 2.0}}
	...
	\vspace{0.5em}
		\includegraphics[height=0.6\textheight]{quantlogo}
	\end{center}
...
\frame{
	...
	\begin{itemize}
		\item is open access
		\item already hosts more than 2000 Quantlets
		\item provides technology to easily share data and programs
		\item makes technology searchable
		\item enhances and encourages collaboration through seamless GitHub integration
		\item visualizes connections between technologies
	\end{itemize}
}
...
\frame{
	...
	\begin{center}
		\includegraphics[width=0.8\textwidth]{githublogo}
	\end{center}
...
\frame{
	...
	\begin{itemize}	
		\item QuantNet is fully integrated with GitHub
		\item Ease of discovery and use of your technology
		\item Audit of your technology
	\end{itemize}	
	Reproducible and transparent science!
}
...
\frame{
	...
	\begin{enumerate}
		\item \textbf{Start:} Create GitHub repository with my code
		\item \textbf{Develop:} Create technology following style guide
		\item \textbf{Publish:} Audit and publish
	\end{enumerate}		
	\textbf{Your Technology:} Easily found, used, and improved!	
}
